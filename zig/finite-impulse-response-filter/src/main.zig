...
export fn main() linksection(".main") void {
    ...
    var dummyArray: [OUTPUT_SIZE]u32 = undefined;
    const dummySink: *volatile [OUTPUT_SIZE]u32 = &dummyArray;
    ...
    uart.uart0Init();
    uart.uartSendString("Zig finite impulse response filter : ");
